...
- Crea la clase de la acción en el paquete `com.tuempresa.facturacion.acciones`, normalmente extendiendo `ViewBaseAction`
...
<controlador nombre="TuPrimeraEntidad">
    ...
    <accion nombre="mostrarImporte" modo="detail"
        clase="com.tuempresa.facturacion.acciones.MostrarImporte"/>
</controlador>
```
...
- ✅ Coloca las clases de acción en `com.tuempresa.facturacion.acciones`
...
- Crea un paquete `cuadrosmando` (ej. `com.tuempresa.facturacion.cuadrosmando`) y coloca la clase `CuadroMando` y sus clases auxiliares en él.
